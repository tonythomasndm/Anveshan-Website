                ...
                <div className="md:grid md:grid-cols-12 md:gap-4">
                    <div className="flex flex-col justify-items-start col-span-8 p-4 md:p-20 justify-start w-full xl:w-3/5 max-xl:px-4">
                        <div className="flex flex-col md:flex-row items-center col-span-8 justify-start w-full xl:w-3/5">
                            <h1 className="mt-4 md:mt-10 text-6xl md:text-8xl max-sm:text-4xl max-sm:leading-tight font-bold text-[#D3FAFF]">
                                Anveshan Hackathon
                            </h1>
                            <h1 className="mt-4 md:mt-10 text-6xl md:text-[192px] text-[#5DECFF] max-sm:text-2xl max-sm:leading-tight font-bold">3.0</h1>
                        </div>
                        <div className="p-4 xxl:p-0 flex flex-col font-semibold w-full text-2xl items-center mt-8">
                            <p className="text-[#5DECFF] mb-7">&lt;date&gt; 12-14 April, 2024 &lt;/date&gt;</p>
                            <BlinkingText/>
                        </div>
                    ...
                    <div className='col-span-4 pl-20 hidden lg:block'>
